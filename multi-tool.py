...
class Breakthrough():
    ...
    def __PlayCardToSequence(self, CardChoice):
        if self.__Hand.GetCardDescriptionAt(CardChoice - 1)[-1] == "m":
            self.__Hand.SetCardToolKit(CardChoice - 1, input("Set card kit type:"))
...
class CardCollection():
    ...
    def SetCardToolKit(self, X, kit):
        self._Cards[X].SetCardToolkit(kit)
